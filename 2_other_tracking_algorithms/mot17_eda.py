...
"""
Muliple object detection = https://motchallenge.net/vis/MOT17-13-SDP/det/
          Ground truth   = https://arxiv.org/pdf/1603.00831.pdf
"""

col_list = ["frame_number","identity_number","left","top","width","height","score","class","visibility"] # gt.txt içerisideki verilerin başlıkları

data = pd.read_csv("gt.txt", names = col_list) # Ground truth 20.000 satır

plt.figure()
sns.countplot(data["class"])

car = data[data["class"] == 3] # Araçları amak için class = 3 

video_path = "MOT17-13-SDP.mp4" 

cap = cv2.VideoCapture(video_path) # video içe aktar

id1 = 29 # Takip etmek istediğimiz aracın numarası
